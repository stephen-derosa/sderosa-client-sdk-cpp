...
```bash
# Terminal 1
LIVEKIT_URL=wss://... LIVEKIT_TOKEN=<receiver-token> ./build-release/bin/BridgeMuteReceiver

# Terminal 2
LIVEKIT_URL=wss://... LIVEKIT_TOKEN=<caller-token>   ./build-release/bin/BridgeMuteCaller
```
...
```bash
./build-release/bin/BridgeMuteCaller wss://... <token> my-receiver
```
...
```
./build-release/bin/BridgeMuteReceiver
...
[RpcManager] Handling track control RPC: mute:mic
[RpcManager] Handling track control RPC: mute:cam
[RpcManager] Handling track control RPC: unmute:mic
[RpcManager] Handling track control RPC: unmute:cam
```

### Caller

```
./build-release/bin/BridgeMuteCaller
