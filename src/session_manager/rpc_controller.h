...
/// @brief Internal RPC controller that owns all RPC concerns for the
/// SessionManager.
 ...
 *
 * Not part of the public API; lives in session_manager/.
 */
class RpcController {
public:
  /// Callback the SessionManager provides to execute a track action
