...
controller_sm.requestRemoteTrackMute("robot-1", "mic");    // mute audio track "mic"
controller_sm.requestRemoteTrackUnmute("robot-1", "mic");  // unmute it
controller_sm.requestTrackRelease("robot-1", "cam"); // unpublish video track "cam"
